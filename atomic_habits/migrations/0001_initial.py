    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('periodicity', models.IntegerField(choices=[(1, 'каждый день'), (2, 'раз в два дня'), (3, 'раз в три дня'), (4, 'раз в четыре дня'), (5, 'раз в пять дней'), (6, 'раз в шесть дней'), (7, 'раз в неделю')], default=1, verbose_name='периодичность')),
                ...
                ('linked_habit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='atomic_habits.habit')),
